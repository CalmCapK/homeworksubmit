...
public class ListHomeworksByTeacherId extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ListHomeworksByTeacherId() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("int lsitllll " + teacherId);
		HomeworkDao homeworkDao = new HomeworkDao();
		ArrayList<Homework> homeworks = homeworkDao.findByTeacherId(teacherId);
