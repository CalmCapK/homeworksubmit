						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select name='collegeId'>
									...
									%>
									<option value='<%=cls.getCollegeId()%>' <%if (cls.getCollegeId() == student.getCollege()) {%>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select name='classId'>
									...
									%>
									<option value='<%=cls.getClassId()%>' <%if (cls.getClassId() == student.getClassId()) {%>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select name="sex">
									...
									<option value='2' <%if (2 == student.getSex()) {%>
											selected='true' <%}%>>
										女
									</option>
								</select>
